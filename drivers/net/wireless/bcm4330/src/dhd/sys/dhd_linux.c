...
dhd_module_init(void)
{
  ...
  printk("gnychis: in the init\n");
    ...
    printk("gnychis: invalid module parameters\n");
		return -EINVAL;
	} while (0);
#endif /* DHDTHREAD */
    ...
    printk("gnychis: platform_driver_register failed\n");
		return  -EINVAL;
	}
    ...
    printk("gnychis: platform_driver_register timeout\n");
		goto fail_1;
	}
    ...
    printk("gnychis: sdio_register_driver failed\n");
		goto fail_1;
	}
    ...
    printk("gnychis: sdio_register_driver timeout\n");
		goto fail_2;
		}
#endif
